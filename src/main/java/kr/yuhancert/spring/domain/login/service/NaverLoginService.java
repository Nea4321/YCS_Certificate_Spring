...
public class NaverLoginService implements SocialLoginService{
    ...
    public SocialUserResponseDTO getUserInfo(String accessToken) {
        ...
        NaverLoginResponseDTO naverLoginResponse = gson.fromJson(jsonString, NaverLoginResponseDTO.class);

        NaverLoginResponseDTO.NaverResponse res = naverLoginResponse.getResponse();
